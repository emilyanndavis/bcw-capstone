; (function () {
    ...
    angular.module('wildlife')
        .service('MapIconService', MapIconService)
    MapIconService.$inject = ['Initializer']


    function MapIconService(Initializer) {
        var $ctrl = this;
        /**
...
*/
        Initializer.mapsInitialized.
            then(function () {
                ...
                $ctrl.SQUARE_PIN = 'M22-48h-44v43h16l6 5 6-5h16z';
                ...
                $ctrl.inherits = function (childCtor, parentCtor) {
                    /** @constructor */
                    function tempCtor() { };
                ...
                $ctrl.inherits(Marker, google.maps.Marker);
